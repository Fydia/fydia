...
use fydia_struct::{roles::{Role, ChannelAccess}, server::ServerId, permission::Permission};
...
impl Model {
    pub fn to_role(&self) -> Role {
        Role {
            ...
            channel_access: serde_json::from_str::<ChannelAccess>(&self.channel_access.clone().unwrap()).unwrap(),
